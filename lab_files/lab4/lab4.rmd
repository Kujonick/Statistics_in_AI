...
```{r fit and vis ordered multinomial}
library(MASS)
...
LDA (Liniowa Analiza Dysklryminacyjna) Metoda statystyczna do
...
QDA (Kwadratowa Analiza Dysklryminacyjna) Rozszerzenie LDA, które
