...
testowym. Oczekiwana precyzja powinna wynieść około 0.98
...
Wersja ze zliczaniem ile razy słowo było użyte w każdym mailu, co o dziwo wcale nie podniosło accuracy

```{python}
from naive_bayes import MultinomialBayes
multi_bayes = MultinomialBayes()
multi_bayes.fit(train_df)

multi_bayes.accuracy(test_df)
